...
def special(char_name, char_class):
    """Функция использования специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Функция проводит симуляцию тренировки."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Функция предназначена для выбора класса персонажа."""
    approve_choice = None
    char_class = None
